...
↠-determinism : {n : ℕ} {A A' A'' : Ty {n}} → A ↠ A' → A ↠ A'' → A' ≡ A''

↠-determinism {n} {.(CaseT _ _)} {.(CaseT _ _)} {.(CaseT _ _)} (ξ-Case x) (ξ-Case x₁) = cong₂ CaseT (⇨-determinism x x₁) refl
↠-determinism {n} {.(CaseT (LabI _) _)} {e*} {e**} (β-Case{ins = ins}) (β-Case{ins = ins'}) rewrite (ins-refl ins ins') = refl
↠-determinism {n} {.(CaseT Blame _)} {.Bot} {.Bot} Case-Bot Case-Bot = refl
...
⇨-determinism {n} {.(Prod _ _)} {.(Prod _ _)} {e*} (ξ-Prod{e₁' = e₁'} r) (β-Prod{v = v}) = contradiction r (⇨-Val-noreduce v e₁')
...
⇨-determinism {n} {.(LetP (ProdV _ _) _)} {.(LetP _ _)} {e*} (ξ-LetP{e₁' = e₁'} r) (β-LetP v v') = contradiction r (⇨-Val-noreduce (VProd v v') e₁')
...
⇨-determinism {n} {.(Prod _ _)} {e*} {.(Prod _ _)} (β-Prod{v = v}) (ξ-Prod{e₁' = e₁'} r') = contradiction r' (⇨-Val-noreduce v e₁')
⇨-determinism {n} {.(Prod _ _)} {e*} {e*} β-Prod β-Prod = refl
...
⇨-determinism {n} {.(LetP (ProdV _ _) _)} {e*} {.(LetP _ _)} (β-LetP v v') (ξ-LetP{e₁' = e₁'} r') = contradiction r' (⇨-Val-noreduce (VProd v v') e₁')
⇨-determinism {n} {.(LetP (ProdV _ _) _)} {e*} {e*} (β-LetP v v') (β-LetP v₁ v'') = refl

⇨-determinism {n} {.(CaseE (LabI _) _)} {e*} {e**} (β-LabE ins) (β-LabE ins₁) rewrite (ins-refl ins ins₁) = refl
...
⇨-determinism {n} {.(Cast e' Dyn Dyn)} {e'} {e*} Cast-Dyn (Cast-Factor-L{nfA = ()} neq)
⇨-determinism {n} {.(Cast e' Dyn Dyn)} {e'} {e*} Cast-Dyn (Cast-Factor-R{nfB = ()} neq)
...
⇨-determinism {n} {.(Cast _ _ Dyn)} {.Blame} {e*} (Cast-Fail{v = v}{tynfB = ()} x) (Cast-Factor-L neq)
⇨-determinism {n} {.(Cast _ Dyn _)} {.Blame} {e*} (Cast-Fail{v = v}{tynfA = ()} x) (Cast-Factor-R neq)
...
⇨-determinism {n} {.(Cast (Cast _ _ Dyn) Dyn _)} {.Blame} {e*} (Cast-Collide{tygH = tygH} x) (Cast-Factor-R{nfB = tynfH} neq) = contradiction (sym (TyG×TyNf-lim⇒match-equiv tygH tynfH)) neq
...
⇨-determinism {n} {.(Cast _ _ _)} {.(Cast _ _ _)} {.(Cast _ _ _)} (Cast-Reduce-L x) (Cast-Reduce-L x₁) = cong₃ Cast refl (↠-determinism x x₁) refl
...
⇨-determinism {n} {.(Cast _ _ Dyn)} {e*} {.Blame} (Cast-Factor-L neq) (Cast-Fail{tynfB = ()} x₁)
⇨-determinism {n} {.(Cast _ _ Dyn)} {e*} {.(Cast _ _ Dyn)} (Cast-Factor-L{nfA = nfA} neq) (Cast-Reduce-L{A' = A'} x₁) = contradiction x₁ (↠-TyNf-noreduce (TyNf-lim⊂TyNf nfA) A')
⇨-determinism {n} {.(Cast _ _ Dyn)} {e*} {e**} (Cast-Factor-L{nfA = nfA} neq) (Cast-Factor-L{nfA = nfA'} neq₁) rewrite (TyNf-lim-uniqueness nfA nfA') = refl
⇨-determinism {n} {.(Cast _ Dyn Dyn)} {e*} {e**} (Cast-Factor-L neq) (Cast-Factor-R{nfB = ()} neq')

⇨-determinism {n} {.(Cast _ Dyn _)} {e*} {.(Cast _ Dyn _)} (Cast-Factor-R{v = v} neq) (ξ-Cast{e₂ = e₂} r') = contradiction r' (⇨-Val-noreduce v e₂)
⇨-determinism {n} {.(Cast e'' Dyn Dyn)} {e*} {e''} (Cast-Factor-R{nfB = ()} neq) Cast-Dyn
⇨-determinism {n} {.(Cast _ Dyn _)} {e*} {.Blame} (Cast-Factor-R neq) (Cast-Fail{tynfA = ()} x₁)
⇨-determinism {n} {.(Cast (Cast e'' _ Dyn) Dyn _)} {e*} {e''} (Cast-Factor-R{nfB = nfB} neq) (Cast-Collapse{tygH = tygH} x₁) = contradiction (sym (TyG×TyNf-lim⇒match-equiv tygH nfB)) neq
⇨-determinism {n} {.(Cast (Cast _ _ Dyn) Dyn _)} {e*} {.Blame} (Cast-Factor-R{nfB = nfB} neq) (Cast-Collide{tygH = tygH} x₁) = contradiction (sym (TyG×TyNf-lim⇒match-equiv tygH nfB)) neq
⇨-determinism {n} {.(Cast _ Dyn _)} {e*} {.(Cast _ Dyn _)} (Cast-Factor-R{nfB = nfB} neq) (Cast-Reduce-R{B' = B'} x₁ x₂) = contradiction x₂ (↠-TyNf-noreduce (TyNf-lim⊂TyNf nfB) B')
⇨-determinism {n} {.(Cast _ Dyn Dyn)} {e*} {e**} (Cast-Factor-R{nfB = ()} neq) (Cast-Factor-L neq')
⇨-determinism {n} {.(Cast _ Dyn _)} {e*} {e**} (Cast-Factor-R{nfB = nfB} neq) (Cast-Factor-R{nfB = nfB'} neq₁) rewrite (TyNf-lim-uniqueness nfB nfB') = refl
⇨-determinism {n} {.(Cast _ Dyn Bot)} {e*} {.Blame} (Cast-Factor-R{nfB = ()} neq) (Cast-Bot-R x₁)
